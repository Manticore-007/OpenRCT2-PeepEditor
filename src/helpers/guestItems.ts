...
export const itemName: string[] = [
		...
		`Map of ${park.name}`,
		`Meatball Soup`,
		`On-ride Photo of ${model._photo1RideName.get()}`,
		`On-ride Photo of ${model._photo2RideName.get()}`,
		`On-ride Photo of ${model._photo3RideName.get()}`,
		`On-ride Photo of ${model._photo4RideName.get()}`,
		`Pizza`,
		`Popcorn`,
		`Pretzel`,
		`Roast Sausage`,
